...
# Deterministically build CleanCoin Core for HOSTs (overridable by environment)
...
for host in ${HOSTS=x86_64-linux-gnu arm-linux-gnueabihf aarch64-linux-gnu riscv64-linux-gnu x86_64-w64-mingw32}; do
    ...
    (
        ...
        #   --share="$PWD"=/CleanCoin
        #
        #                     maps our current working directory to /CleanCoin
        ...
        #     container so that we have something to build. '/CleanCoin' was
        #     chosen arbitrarily.
        #
        ...
        time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                                 ...
                                 -- env HOST="$host" \
                                      ...
                                      bash -c "cd /CleanCoin && bash contrib/guix/libexec/build.sh"
    )
