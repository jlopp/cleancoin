# Bootstrappable CleanCoin Core Builds

This directory contains the files necessary to perform bootstrappable CleanCoin
Core builds.
...
- 24GB of free disk space on the partition that the CleanCoin Core git repository
  resides in
...
For a CleanCoin Core depends development environment, simply invoke
...
From the top of a clean CleanCoin Core repository:
...
To use dongcarl's substitute server for CleanCoin Core builds after having
