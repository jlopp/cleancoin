...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the CleanCoin repository."
  exit 1
fi
...
# See https://github.com/CleanCoin/CleanCoin/issues/16064
...
echo 'When compiling CleanCoind, run `./configure` in the following way:'
echo
