...
[CleanCoin](https://www.cleancoin.net)

What is CleanCoin?
----------------

[CleanCoin](https://www.cleancoin.net) is an digital currency that enables instant payments to
anyone, anywhere in the world. CleanCoin uses peer-to-peer technology to operate
...
CleanCoin is released under the terms of the MIT license. See [COPYING](COPYING) for more
