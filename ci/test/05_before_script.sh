...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/CleanCoin
else
  DOCKER_EXEC echo \> \$HOME/.CleanCoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/CleanCoin/CleanCoin/pull/18288#discussion_r433189350 for
  # details.
