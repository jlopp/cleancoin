// Copyright (c) 2015-2018 The CleanCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef CleanCoin_ZMQ_ZMQABSTRACTNOTIFIER_H
#define CleanCoin_ZMQ_ZMQABSTRACTNOTIFIER_H
...
#endif // CleanCoin_ZMQ_ZMQABSTRACTNOTIFIER_H
