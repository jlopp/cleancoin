...
void StakePage::setBalance(const interfaces::WalletBalances& balances)
{
    ...
    m_balances = balances;
    ui->labelAssets->setText(CleanCoinUnits::formatWithUnit(unit, balances.stakeable, false, CleanCoinUnits::SeparatorStyle::ALWAYS));
    ui->labelOwnedAssets->setText(CleanCoinUnits::formatWithUnit(unit, balances.stakeable - balances.stakeable_delegations, false, CleanCoinUnits::SeparatorStyle::ALWAYS));
    ui->labelDelegations->setText(CleanCoinUnits::formatWithUnit(unit, balances.stakeable_delegations, false, CleanCoinUnits::SeparatorStyle::ALWAYS));
    ui->labelAssetsImmature->setText(CleanCoinUnits::formatWithUnit(unit, balances.immature_stakeable, false, CleanCoinUnits::SeparatorStyle::ALWAYS));
    ...
    ui->labelStake->setText(CleanCoinUnits::formatWithUnit(unit, balances.stake, false, CleanCoinUnits::SeparatorStyle::ALWAYS));
    ui->labelDelegatedAssets->setText(CleanCoinUnits::formatWithUnit(unit, balances.delegated + balances.immature_delegated, false, CleanCoinUnits::SeparatorStyle::ALWAYS));
}
...
void StakePage::numBlocksChanged(int count, const QDateTime &, double, bool headers)
{
    ...
    {
        ui->labelHeight->setText(CleanCoinUnits::formatInt(count));
...
{
    int unit = walletModel->getOptionsModel()->getDisplayUnit();
    QString strSubsidy = CleanCoinUnits::formatWithUnit(unit, m_subsidy, false, CleanCoinUnits::SeparatorStyle::ALWAYS) + "/Block";
    ui->labelReward->setText(strSubsidy);
}

void StakePage::updateNetworkWeight()
{
    ui->labelWeight->setText(CleanCoinUnits::formatInt(m_networkWeight / COIN));
}
