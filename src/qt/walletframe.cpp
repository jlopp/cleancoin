...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, CleanCoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &CleanCoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &CleanCoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &CleanCoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &CleanCoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &CleanCoinGUI::updateWalletStatus);
    connect(gui, &CleanCoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
