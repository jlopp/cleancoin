        ...
        platformStyle(_platformStyle)
{
    columns << QString() << QString() << tr("Date") << tr("Type") << tr("Label")
        << CleanCoinUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit())
        << CleanCoinUnits::getDelegatedColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
{
    columns[Amount] = CleanCoinUnits::getAmountColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
    columns[Delegated] = CleanCoinUnits::getDelegatedColumnTitle(walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed, CleanCoinUnits::SeparatorStyle separators) const
{
    QString str = CleanCoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->credit + wtx->debit, false, separators);
    if(showUnconfirmed)
    {
...
QString TransactionTableModel::formatTxDelegated(const TransactionRecord *wtx, bool showUnconfirmed, CleanCoinUnits::SeparatorStyle separators) const
{
    QString str = CleanCoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), wtx->delegated, false, separators);
    if(showUnconfirmed)
    {
        if(!wtx->status.countsForBalance)
        {
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const
{
    ...
    case Qt::DisplayRole:
        ...
        case Amount:
            return formatTxAmount(rec, true, CleanCoinUnits::SeparatorStyle::ALWAYS);
        case Delegated:
            return formatTxDelegated(rec, true, CleanCoinUnits::SeparatorStyle::ALWAYS);
        }
        break;
    case Qt::EditRole:
    ...
    case TxPlainTextRole:
        {
            ...
            details.append(formatTxAmount(rec, false, CleanCoinUnits::SeparatorStyle::NEVER));
            return details;
        }
    case ConfirmedRole:
    ...
    case FormattedAmountRole:
        ...
        return formatTxAmount(rec, false, CleanCoinUnits::SeparatorStyle::NEVER);
    case StatusRole:
