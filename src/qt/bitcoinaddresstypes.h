...
#ifndef CleanCoin_QT_CleanCoinADDRESSTYPES_H
#define CleanCoin_QT_CleanCoinADDRESSTYPES_H
...
/** CleanCoin adress type definitions. Encapsulates parsing
   and serves as list model for drop-down selection boxes.
*/
class CleanCoinAddressTypes: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CleanCoinAddressTypes(QObject *parent);
...
typedef CleanCoinAddressTypes::AddressType CleanCoinAddressType;

#endif // CleanCoin_QT_CleanCoinADDRESSTYPES_H
