...
#ifndef CleanCoin_QT_SENDCOINSENTRY_H
#define CleanCoin_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending CleanCoins.
...
#endif // CleanCoin_QT_SENDCOINSENTRY_H
