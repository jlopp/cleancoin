...
#ifndef CleanCoin_QT_GUIUTIL_H
#define CleanCoin_QT_GUIUTIL_H
...
/** Utility functions used by the CleanCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "CleanCoin:" URI into recipient object, return true on successful parsing
