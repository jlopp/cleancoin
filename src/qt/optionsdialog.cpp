    ...
    mapper(nullptr)
{
    ...
    ui->CleanCoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->CleanCoinAtStartup);
    ...
    ui->CleanCoinAtStartup->setToolTip(ui->CleanCoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->CleanCoinAtStartup->setText(ui->CleanCoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openCleanCoinConfButton->setToolTip(ui->openCleanCoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new CleanCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->CleanCoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCleanCoinConfButton_clicked()
{
