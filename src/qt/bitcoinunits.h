...
#ifndef CleanCoin_QT_CleanCoinUNITS_H
#define CleanCoin_QT_CleanCoinUNITS_H
...
/** CleanCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CleanCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CleanCoinUnits(QObject *parent);

    /** CleanCoin units.
      @note Source: https://en.CleanCoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BPS,
    ...
    //! Number of gretas (1e-8) per unit
    ...
    //! Return maximum number of base units (gretas)
    static CAmount maxMoney();

private:
    QList<CleanCoinUnits::Unit> unitlist;
};
typedef CleanCoinUnits::Unit CleanCoinUnit;

#endif // CleanCoin_QT_CleanCoinUNITS_H
