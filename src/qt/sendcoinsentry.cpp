    ...
    forDelegation(_forDelegation)
{
    ...
    // normal CleanCoin address field
    ...
    // just a label for displaying CleanCoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &CleanCoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
