...
//! Entry point for CleanCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &CleanCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for CleanCoinGUI tests.
void AppTests::guiTests(CleanCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &CleanCoinGUI::consoleShown, this, &AppTests::consoleTests);
