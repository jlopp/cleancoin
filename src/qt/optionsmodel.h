...
#ifndef CleanCoin_QT_OPTIONSMODEL_H
#define CleanCoin_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for CleanCoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // CleanCoinUnits::Unit
...
#endif // CleanCoin_QT_OPTIONSMODEL_H
