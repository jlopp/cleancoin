...
static void SetupCleanCoinTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " CleanCoin-pos-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  CleanCoin-pos-tx [options] <hex-tx> [commands]  Update hex-encoded CleanCoin transaction\n" +
            "or:     CleanCoin-pos-tx [options] -create [commands]   Create hex-encoded CleanCoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded CleanCoin transaction
