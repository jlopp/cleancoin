...
#ifndef CleanCoin_TEST_SCRIPTNUM10_H
#define CleanCoin_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from CleanCoin Core 0.10.0, for cross-comparison.
 */
public:
