 ...
 */
#ifndef CleanCoin_UTIL_SYSTEM_H
#define CleanCoin_UTIL_SYSTEM_H
...
extern const char * const CleanCoin_CONF_FILENAME;
extern const char * const CleanCoin_SETTINGS_FILENAME;
