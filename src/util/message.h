...
#ifndef CleanCoin_UTIL_MESSAGE_H
#define CleanCoin_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's CleanCoin address, it must refer to a public key.
...
#endif // CleanCoin_UTIL_MESSAGE_H
