...
#ifndef CleanCoin_WALLET_WALLET_H
#define CleanCoin_WALLET_WALLET_H
...
//! Discourage users to set fees higher than this amount (in gretas) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{COIN / 100};
//! -maxtxfee will warn if called with a higher fee than this amount (in gretas)
...
public:
     ...
     * on this CleanCoin node, and set to 0 for transactions that were created
...
public:
    ...
    /** Absolute maximum transaction fee (in gretas) used by default for the wallet */
...
#endif // CleanCoin_WALLET_WALLET_H
