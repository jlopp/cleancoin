...
#ifndef CleanCoin_WALLET_WALLETUTIL_H
#define CleanCoin_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! CleanCoin from opening the wallet, thinking it was newly created, and
...
#endif // CleanCoin_WALLET_WALLETUTIL_H
