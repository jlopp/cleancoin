// Copyright (c) 2017-2018 The CleanCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef CleanCoin_WALLET_COINSELECTION_H
#define CleanCoin_WALLET_COINSELECTION_H
...
#endif // CleanCoin_WALLET_COINSELECTION_H
