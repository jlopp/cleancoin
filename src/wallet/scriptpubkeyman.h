...
#ifndef CleanCoin_WALLET_SCRIPTPUBKEYMAN_H
#define CleanCoin_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The CleanCoin Core wallet was originally a collection of unrelated private
...
#endif // CleanCoin_WALLET_SCRIPTPUBKEYMAN_H
