...
#ifndef CleanCoin_COMPAT_ASSUMPTIONS_H
#define CleanCoin_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "CleanCoin cannot be compiled without assertions."
#endif
...
#endif // CleanCoin_COMPAT_ASSUMPTIONS_H
