...
#ifndef CleanCoin_INTERFACES_NODE_H
#define CleanCoin_INTERFACES_NODE_H
...
//! Top-level interface for a CleanCoin node (CleanCoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // CleanCoin_INTERFACES_NODE_H
