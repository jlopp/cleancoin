...
#ifndef CleanCoin_COINS_H
#define CleanCoin_COINS_H
...
public:
    ...
    /**
     * Amount of CleanCoins coming in to a transaction
 ...
 * between CleanCoind, and CleanCoin-qt and non-server tools.
 *
