...
#ifndef CleanCoin_SCRIPT_SCRIPT_H
#define CleanCoin_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, CleanCoin always counted CHECKMULTISIGs
...
#endif // CleanCoin_SCRIPT_SCRIPT_H
