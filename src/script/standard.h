...
#ifndef CleanCoin_SCRIPT_STANDARD_H
#define CleanCoin_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a CleanCoin address
 */
...
/**
 * Generate a CleanCoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // CleanCoin_SCRIPT_STANDARD_H
