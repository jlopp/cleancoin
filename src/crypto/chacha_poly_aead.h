...
#ifndef CleanCoin_CRYPTO_CHACHA_POLY_AEAD_H
#define CleanCoin_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@CleanCoin.
 *
 ...
 *
 * The chacha20-poly1305@CleanCoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@CleanCoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@CleanCoin are relatively fast in
...
#endif // CleanCoin_CRYPTO_CHACHA_POLY_AEAD_H
