...
#ifndef CleanCoin_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define CleanCoin_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // CleanCoin_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
