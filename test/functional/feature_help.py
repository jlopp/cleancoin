...
"""Verify that starting CleanCoin with -h works as expected."""

from test_framework.test_framework import CleanCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(CleanCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start CleanCoin with -h for help text")
        ...
        self.log.info("Start CleanCoin with -version for version information")
        ...
        self.log.info("Start CleanCoind with -fakearg to make sure it does not start")
