...
class P2PPermissionsTests(CleanCoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].CleanCoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].CleanCoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
