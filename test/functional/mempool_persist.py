...
By default, CleanCoind will dump mempool on shutdown and
...
class MempoolPersistTest(CleanCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent CleanCoind from writing mempool.dat to disk. Verify that `savemempool` fails")
