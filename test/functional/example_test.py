...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CleanCoinTestFramework
    pass


class ExampleTest(CleanCoinTestFramework):
    # Each functional test is a subclass of the CleanCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        CleanCoinTestFramework class so other tests can use it."""
