...
class TestShell:
    """Wrapper Class for CleanCoinTestFramework.

    The TestShell class extends the CleanCoinTestFramework
    ...
    class __TestShell(CleanCoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by CleanCoinTestFramework child class.
            self.num_nodes = 1
