...
// CleanCoin includes.
#include <..\src\script\CleanCoinconsensus.h>
...
int main()
{
    std::cout << "CleanCoinconsensus version: " << CleanCoinconsensus_version() << std::endl;
    ...
    auto op0Result = CleanCoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, CleanCoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
