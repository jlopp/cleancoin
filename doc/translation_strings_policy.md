...
This document provides guidelines for internationalization of the CleanCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `CleanCoin_en.ts` remains unchanged.
