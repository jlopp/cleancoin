CleanCoin version 0.7.2 is now available from:
  http://sourceforge.net/projects/CleanCoin/files/CleanCoin/CleanCoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused CleanCoin-Qt to crash on Windows when exiting.
