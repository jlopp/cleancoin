...
CleanCoin Core version 0.19.1 is now available from:

  <https://CleanCoincore.org/bin/CleanCoin-core-0.19.1/>
...
From CleanCoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as CleanCoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, CleanCoin Core does not yet change appearance when
...
- #17488 fix "CleanCoind already running" warnings on macOS (fanquake)
