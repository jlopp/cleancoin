Download URL: https://sourceforge.net/projects/CleanCoin/files/CleanCoin/CleanCoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 CLN fee schedule (users still pay 0.01 CLN per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #CleanCoin00 - #CleanCoin99
