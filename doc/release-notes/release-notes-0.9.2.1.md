CleanCoin Core version 0.9.2.1 is now available from:

  https://CleanCoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 CLN to 0.01 CLN
...
- Fix "Start CleanCoin on system login"
