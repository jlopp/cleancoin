CleanCoin Core version 0.10.3 is now available from:

  <https://CleanCoin.org/bin/CleanCoin-core-0.10.3/>
...
(see https://github.com/CleanCoin/CleanCoin/pull/6793, as well as the 0.11.0
