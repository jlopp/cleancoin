CleanCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/CleanCoin/files/CleanCoin/CleanCoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the CleanCoin
...
New/changed settings (command-line or CleanCoin.conf file)
--------------------------------------------------------
