CleanCoin Core version 0.10.4 is now available from:

  <https://CleanCoin.org/bin/CleanCoin-core-0.10.4/>
...
- #6953 `43c2789` Split CleanCoin-tx into its own package
- #6953 `dfe0d4d` Include CleanCoin-tx binary on Debian/Ubuntu
