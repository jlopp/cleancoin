CleanCoin Core version *0.15.0.1* is now available from:

  <https://CleanCoin.org/bin/CleanCoin-core-0.15.0.1/>

and

  <https://CleanCoincore.org/bin/CleanCoin-core-0.15.0.1/>
