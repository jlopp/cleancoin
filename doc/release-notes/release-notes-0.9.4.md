CleanCoin Core version 0.9.4 is now available from:

  https://CleanCoin.org/bin/0.9.4/
...
this update is incompatible with the CleanCoin system and could lead to consensus
forks.

CleanCoin Core released binaries from https://CleanCoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~CleanCoin/+archive/ubuntu/CleanCoin
- A third-party or self-compiled CleanCoin Core

upgrade to CleanCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
