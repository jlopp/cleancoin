CleanCoin Core version 0.16.1 is now available from:

  <https://CleanCoincore.org/bin/CleanCoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting CleanCoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure CleanCoind processes are cleaned up when tests end (sdaftuar)
