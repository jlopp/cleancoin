CleanCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/CleanCoin/files/CleanCoin/CleanCoin-0.5.4/
...
http://gitorious.org/CleanCoin/CleanCoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix CleanCoin-Qt notifications under Growl 1.3.
Increase required age of CleanCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCleanCoin properly when installing CleanCoin-Qt over it. (Windows)
