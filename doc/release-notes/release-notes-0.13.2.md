CleanCoin Core version 0.13.2 is now available from:

  <https://CleanCoin.org/bin/CleanCoin-core-0.13.2/>
...
- #8908 `4a974b2` Update CleanCoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow CleanCoin-tx to create v2 transactions (CLNdrak)
